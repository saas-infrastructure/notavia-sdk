...
Drop-in `<notifyservice-prefs>` Lit 3 web component for the Notavia preference centre.
...
|----------------------|------|----------|---------|-------------|
| `publishable-key` | `string` | Yes | — | Your Notavia publishable API key. Begins with `npk_live_` or `npk_test_`. |
