...
Official Go client for [Notavia](https://saas-infrastructure.com/products/notify) — send transactional email and manage templates.
...
ok := webhooks.Verify(
	string(rawBody),
	r.Header.Get("NotifyService-Signature"),
