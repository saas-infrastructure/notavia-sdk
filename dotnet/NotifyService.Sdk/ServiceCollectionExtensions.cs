...
public static class ServiceCollectionExtensions
{
    ...
    private static IServiceCollection AddInternal(IServiceCollection services)
    {
        ...
        services.AddTransient<ResilienceTimeoutTranslationHandler>();
        ...
        builder.AddStandardResilienceHandler().Configure((options, serviceProvider) =>
        {
            ...
            options.TotalRequestTimeout.Timeout = opts.Timeout > options.AttemptTimeout.Timeout
                ? opts.Timeout
                : options.AttemptTimeout.Timeout;
        });

        ReapplyConfiguredTimeoutBecauseTheResilienceHandlerDisablesIt(builder);
    ...
    private static void ReapplyConfiguredTimeoutBecauseTheResilienceHandlerDisablesIt(
        IHttpClientBuilder builder) =>
        builder.ConfigureHttpClient((sp, http) =>
            http.Timeout = sp.GetRequiredService<IOptions<NotifyOptions>>().Value.Timeout);
}
