...
Headless TypeScript client for the Notavia in-app inbox. Owns the SignalR connection, token lifecycle, REST calls, optimistic mark-read with rollback, and a typed event bus. No DOM dependency — works in browsers and Node.
