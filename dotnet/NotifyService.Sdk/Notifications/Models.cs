...
/// </summary>
/// <param name="Channel">Channel name. Use a <see cref="NotificationChannel"/> constant —
/// <c>"email"</c>, <c>"in_app"</c>, <c>"sms"</c>, <c>"slack"</c>, <c>"teams"</c>, <c>"discord"</c>
/// or <c>"webhook"</c>. Availability depends on the plan.</param>
