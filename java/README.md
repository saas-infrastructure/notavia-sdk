...
Official Java client for [Notavia](https://docs.notavia.saas-infrastructure.com) — send transactional email and manage templates.
...
boolean isValid = Webhooks.verifySignature(
    rawBody,
    request.getHeader("X-Notify-Signature"),
    "whsec_..."
);
if (!isValid) {
