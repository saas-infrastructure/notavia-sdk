...
class BulkSetUserPreferencesRequest(BaseModel):
    """
    BulkSetUserPreferencesRequest
    """ # noqa: E501
    preferences: List[BulkSetUserPreferencesRequestPreferencesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "preferences": [BulkSetUserPreferencesRequestPreferencesInner.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None
        })
        return _obj
