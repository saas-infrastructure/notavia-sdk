# notifyservice_api.UsageApi

All URIs are relative to *https://your-notavia-host*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_usage**](UsageApi.md#get_usage) | **GET** /v1/usage | Get current-period usage and plan limits
...
with notifyservice_api.ApiClient(configuration) as api_client:
    ...
    api_instance = notifyservice_api.UsageApi(api_client)
...
|-------------|-------------|------------------|
**200** | Current-period usage and plan limits. |  -  |
