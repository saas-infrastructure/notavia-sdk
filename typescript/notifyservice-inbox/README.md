...
White-label `<notifyservice-inbox>` custom element for the NotifyService in-app inbox. Three variants (`bell` | `panel` | `list`), real-time push via SignalR, and fully themeable with CSS custom properties.
